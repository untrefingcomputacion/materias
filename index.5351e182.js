...
})({"66wRw":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "aca47fb45351e182";
"use strict";
...
},{}],"gE79E":[function(require,module,exports) {
...
const mapCorrelativas = (materia, key)=>{
    return {
        ...materia,
        correlativas: _utils.correlatividades[key]
    };
};
const checkRegularizable = (materia, listadoMaterias)=>{
    return (materia.instancia === null || materia.instancia === 'En Curso') && materia.correlativas.every((correlativa)=>[
            'Equivalencia',
            'Regularidad',
            'Examen'
        ].includes(listadoMaterias[correlativa].instancia)
    ) && materia.correlativas.some((correlativa)=>listadoMaterias[correlativa].instancia === 'Regularidad'
    );
};
const checkAprobable = (materia, listadoMaterias)=>{
    return materia.instancia !== 'Examen' && materia.instancia !== 'Equivalencia' && (materia.correlativas === [] || materia.correlativas.every((correlativa)=>[
            'Equivalencia',
            'Examen'
        ].includes(listadoMaterias[correlativa].instancia)
    ));
...
const agruparMaterias = (materias)=>{
    ...
    for(const key in materias)if (Object.hasOwnProperty.call(materias, key)) {
        const element = materias[key];
        if (element.regularizable) regularizables[key] = element;
        if (element.aprobable) aprobables[key] = element;
        if (element.regularizada) regularizadas[key] = element;
        if (element.aprobada) aprobadas[key] = element;
    }
    return {
        regularizables,
        regularizadas,
...
const estilizar = (materias, funcEstilo)=>{
    for(const key in materias)if (Object.hasOwnProperty.call(materias, key)) funcEstilo(key);
};
...
const calcular = ()=>{
    ...
    const materiasYCorrelativas = _utils.mapObject(materiasRaw.reduce(mapMateria, {
    }), mapCorrelativas);
    const materias = _utils.mapObject(materiasYCorrelativas, mapCursadasYFinales, {
        listadoMaterias: materiasYCorrelativas
    });
...
},{"./utils":"4z3Uv"}],"4z3Uv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mapObject", ()=>mapObject
);
parcelHelpers.export(exports, "correlatividades", ()=>correlatividades
);
const mapObject = (obj, func, extraParams)=>{
    return Object.fromEntries(Object.entries(obj).map(([k, v])=>[
            k,
            func(v, k, extraParams)
        ]
    ));
};
...
},{}]},["66wRw","gE79E"], "gE79E", "parcelRequire94c2")

//# sourceMappingURL=index.5351e182.js.map
